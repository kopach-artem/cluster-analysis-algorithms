...
def KMeansPlus(data : pd.DataFrame, par1 : str, par2 : str):
    data = data[[par1, par2]]
...
# Visualising the clusters
    ...
    plt.scatter(data_scaled[y_kmeans == 3, 0], data_scaled[y_kmeans == 3, 1], s = 100, c = 'cyan', label = 'Cluster 4')
    plt.scatter(data_scaled[y_kmeans == 4, 0], data_scaled[y_kmeans == 4, 1], s = 100, c = 'magenta', label = 'Cluster 5')
